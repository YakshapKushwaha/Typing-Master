...
class Game:
    ...
    def __init__(self):
        ...
        pygame.init()
        self.open_img = pygame.image.load('images/262710.jpg')
        self.open_img = pygame.transform.scale(self.open_img, (self.w, self.h))

        self.bg = pygame.image.load('images/nostalgia-commodore-64-commodore-gameboy-console-hd-wallpaper-preview.jpg.')
        self.bg = pygame.transform.scale(self.bg, (1600, 900))

        self.screen = pygame.display.set_mode((self.w, self.h))
        pygame.display.set_caption('RKGIT MINI PROJECT')
